...
public class State {
	...
	private Set<abstractdt.Diff> differences;
	 ...
	 * @param dom
	 */
	public State(String stateId, String url, String name,
	...
	public Set<abstractdt.Diff> getDiffs() {
		return differences;
	}

	public void setDiffs(Set<abstractdt.Diff> differences) {
